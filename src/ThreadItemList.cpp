...
**/
#include "ThreadItemList.h"

ThreadItemList::~ThreadItemList()
{
}

/*
bool ThreadItemList::AddItem(ThreadItem *item)
{
	return BList::AddItem((void *)item);
}

ThreadItem *ThreadItemList::ItemAt(int32 index)
{
	return (ThreadItem *)BList::ItemAt(index);
}
